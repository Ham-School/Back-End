...
const MAXIMOS_INTENTOS = 8, // Intentos máximos que tiene el jugador
    ...
    NOMBRE_IMAGEN_OCULTA = "static/main/img/question.png"; // La imagen que se muestra cuando la real está oculta
new Vue({
    el: "#app",
    data: () => ({
        ...
        imagenes: [
            ...
            "static/main/img/blue.jpg",
            "static/main/img/red.jpg",
            "static/main/img/yell.jpg",
            "static/main/img/eyes.png",
            "static/main/img/head.png",
            "static/main/img/toes.jpg",
        ],
        memorama: [],
    ...
    methods: {
        ...
        indicarFracaso() {
            Swal.fire({
                    title: "Perdiste",
                    html: `
                <img class="img-fluid" src="static/main/img/perdiste.png" alt="Perdiste">
        ...
        indicarVictoria() {
            Swal.fire({
                    title: "¡Ganaste!",
                    html: `
                <img class="img-fluid" src="static/main/img/ganaste.png" alt="Ganaste">
